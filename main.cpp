...
// Milestone 1
const string NAMES_LIST[40] = {"Liam", "Emma", "Noah", "Olivia", "Ethan", "Ava", "Mason", "Sophia", "Logan", "Isabella", "Lucas", "Mia", "Alexander", "Charlotte", "Henry", "Amelia", "Jack", "Evelyn", "Samuel", "Harper", "Owen", "Aria", "Caleb", "Ella", "Isaac", "Grace", "Julian", "Chloe", "Levi", "Scarlett", "Nathan", "Lily", "Gabriel", "Nora", "Dominic", "Hazel", "Xavier", "Penelope", "Silas", "Aurora"};
...
// Milestone 4
const string BRACELET_LIST[20] = {"Cerulean", "Marigold", "Forest Green", "Coral Pink", "Indigo", "Mint Green", "Burgundy", "Lavender", "Charcoal Gray", "Teal", "Goldenrod", "Peach", "Navy Blue", "Turquoise", "Crimson", "Sage Green", "Magenta", "Sand Brown", "Sky Blue", "Plum"};
// Milestone 5 
